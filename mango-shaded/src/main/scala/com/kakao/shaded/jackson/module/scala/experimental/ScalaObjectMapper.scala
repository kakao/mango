...
import com.kakao.shaded.jackson.core._
import com.kakao.shaded.jackson.databind._
import com.kakao.shaded.jackson.databind.jsonFormatVisitors.JsonFormatVisitorWrapper
import com.kakao.shaded.jackson.databind.jsonschema.JsonSchema
...
trait ScalaObjectMapper {
  ...
  /**
   * Convenience method for constructing [[com.kakao.shaded.jackson.databind.JavaType]] out of given
   ...
   * In either case [[com.kakao.shaded.jackson.core.JsonParser]] must point to the first token of
   * the first element, OR not point to any token (in which case it is advanced
   * to the next token). This means, specifically, that for wrapped sequences,
   * parser MUST NOT point to the surrounding <code>START_ARRAY</code> but rather
   * to the token following it.
   * <p>
   * Note that [[com.kakao.shaded.jackson.databind.ObjectReader]] has more complete set of variants.
   */
  ...
  /**
   * Factory method for constructing [[com.kakao.shaded.jackson.databind.ObjectWriter]] that will
  ...
  /**
   * Factory method for constructing [[com.kakao.shaded.jackson.databind.ObjectReader]] that will
